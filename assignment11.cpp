/* 
Aim:  Implement direct access file for any Database and perform following operations on it i) Create
Database ii) Display Database iii) Search a record

To implement Direct Access File ,Collision handling throgh linear probing with chaining and
without replacement.
 */
